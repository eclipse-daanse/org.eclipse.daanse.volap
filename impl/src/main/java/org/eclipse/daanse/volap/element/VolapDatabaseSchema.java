...
public class VolapDatabaseSchema implements DatabaseSchema {
	private String name;
	...
	public void addDatabaseColumn(DatabaseTable databaseTable) {
		if (dbTables == null) {
			dbTables = new ArrayList<DatabaseTable>();
		}
