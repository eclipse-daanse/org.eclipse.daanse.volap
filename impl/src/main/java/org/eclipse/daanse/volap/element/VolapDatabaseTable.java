...
public class VolapDatabaseTable implements DatabaseTable {
	...
	public void addDatabaseColumn(DatabaseColumn databaseColumn) {
		if (dbColumns == null) {
			dbColumns = new ArrayList<DatabaseColumn>();
		}
		dbColumns.add(databaseColumn);
	}
